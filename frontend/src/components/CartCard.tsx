...
const CartCard: React.FC<CartCardProps> = ({product,quantityChangeHandler,removeFromCartHandler,}) => {

  const [quantity, setQuantity] = useState(product.quantity);
  const totalPrice = (product.discountPrice || product.originalPrice) * quantity;
